...
import '../../../modifyer/field_detector.dart';
import '../../../modifyer/ktp_data_model_converter.dart';


abstract class ScanKtpMlKitLocalDatasource{
  Future<KtpDataModel> scanKtp({@required File fileImage});
}
class ScanKtpMlKitImpl implements ScanKtpMlKitLocalDatasource {
  final TextRecognizer? textRecognizer;

  ScanKtpMlKitImpl({@required this.textRecognizer});

  @override
  Future<KtpDataModel> scanKtp({File? fileImage}) async {
    ...
    return KtpDataModelConverter.from(
